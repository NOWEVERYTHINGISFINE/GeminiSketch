...
// 新增从GeminiSketch引入的查询函数声明
int vertexQuery(Horae* horae, uint64_t vertex, time_type t_b, time_type t_e);
int totalOutgoingWeight(Horae* horae, uint64_t vertex, time_type t_b, time_type t_e);
int outgoingEdgeCount(Horae* horae, uint64_t vertex, time_type t_b, time_type t_e);
...
// 新增并行查询函数
int vertexQueryHoraeTest_para(Horae* horae, string input_dir, string output_dir, string dataset_name, vector<int> num, int query_times, bool write, time_type t_b, time_type t_e);
int totalOutgoingWeightHoraeTest_para(Horae* horae, string input_dir, string output_dir, string dataset_name, vector<int> num, int query_times, bool write, time_type t_b, time_type t_e);
int outgoingEdgeCountHoraeTest_para(Horae* horae, string input_dir, string output_dir, string dataset_name, vector<int> num, int query_times, bool write, time_type t_b, time_type t_e);
...
// seq query functions
// 新增串行查询函数
int vertexQueryHoraeTest_seq(Horae* horae, string input_dir, string output_dir, string dataset_name, vector<int> num, int query_times, bool write, time_type t_b, time_type t_e);
int totalOutgoingWeightHoraeTest_seq(Horae* horae, string input_dir, string output_dir, string dataset_name, vector<int> num, int query_times, bool write, time_type t_b, time_type t_e);
int outgoingEdgeCountHoraeTest_seq(Horae* horae, string input_dir, string output_dir, string dataset_name, vector<int> num, int query_times, bool write, time_type t_b, time_type t_e);
...
// 新增主函数调用的查询函数
void vertexQueryHoraeTest(bool para_query, Horae* horae, string input_dir, string output_dir, string dataset_name, vector<int> num, int query_times, bool write, time_type t_b, time_type t_e);
void totalOutgoingWeightHoraeTest(bool para_query, Horae* horae, string input_dir, string output_dir, string dataset_name, vector<int> num, int query_times, bool write, time_type t_b, time_type t_e);
void outgoingEdgeCountHoraeTest(bool para_query, Horae* horae, string input_dir, string output_dir, string dataset_name, vector<int> num, int query_times, bool write, time_type t_b, time_type t_e);
...
#endif
		int tt = ceil((double)(t - pg->getStartTime()) / (double)pg->getTimeLength());
#ifdef MEM
